    ...
    <section className="valuesSection" id="values">
            ...
            <div className="valuesSection__wrapper">
                ...
                <div className="valueOne">
                    ...
                    <p className="valueOne__text">I pour my heart into any endeavors I embark on showing up fully committed and dedicated.</p>
                </div>
                ...
                <div className="valueFive">
                    ...
                    <p className="valueFive__text">Treating others in a way that proves there's goodness & beauty in the world.</p>
                </div>
