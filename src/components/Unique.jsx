         ...
         <div className="uniqueSection__uniquenesses">
            <div className="uniqueness uniquenessOne">
              ...
              <div className="uniqueness__wrapper">
                <h2 className="uniqueness__wrapper--title">Tech</h2>
                <p className="uniqueness__wrapper--description">I am in love with technology, coding and design and that makes me pour my heart and love into the projects I undertake.</p>
              </div>
            </div>
            ...
            <div className="uniqueness uniquenessTwo">
              ...
              <div className="uniqueness__wrapper">
                <h2 className="uniqueness__wrapper--title englishTitle">English</h2>
                <p className="uniqueness__wrapper--description englishDescription">I have cultivated a fluent level thanks to my big passion for the language. Plus, I thrive off of being in international environments.</p>
              </div>
            </div>
            ...
            <div className="uniqueness uniquenessThree">
              ...
              <div className="uniqueness__wrapper">
                <h2 className="uniqueness__wrapper--title">Coaching</h2>
                <p className="uniqueness__wrapper--description"> The more you understand yourself, the more you will be able to reach your potential. My training as a life coach has revolutionized </p>
              </div>
            </div>
            ...
            <div  className="uniqueness uniquenessFour">
              ...
              <div className="uniqueness__wrapper">
                <h2 className="uniqueness__wrapper--title yogaTitle">Yoga</h2>
                <p className="uniqueness__wrapper--description yogaDescription"> Progress and excellence is an accumulation of small steps in the right direction. This practice has made me reached new levels of patience, consistency, work ethic, and commitment.</p>
              </div>
            </div>
         </div>
